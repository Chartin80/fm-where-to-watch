 ...
 * `wstSlug`     — the slug WST uses BEFORE the "-tv-schedule" suffix
 *                 (so https://worldsoccertalk.com/<wstSlug>-tv-schedule/).
 *                 Set to null to skip a competition (no upstream coverage).
...
export const COMPETITIONS = [
	...
	{ slug: 'eng-premier',     label: 'English Premier League', region: 'Europe',        priority: 10, wstSlug: 'premier-league' },
	...
	{ slug: 'fra-ligue1',      label: 'Ligue 1',                 region: 'Europe',        priority: 14, wstSlug: null }, // no WST coverage
	...
	{ slug: 'eng-champ',       label: 'English Championship',    region: 'Europe',        priority: 22, wstSlug: 'championship' },
	...
	{ slug: 'uefa-uecl',       label: 'UEFA Conference League',  region: 'UEFA',          priority: 32, wstSlug: 'conference-league' },
	...
	{ slug: 'arg-primera',     label: 'Liga Profesional Argentina', region: 'Americas',   priority: 42, wstSlug: 'superliga-argentina' },
	{ slug: 'bra-serieA',      label: 'Brasileirão Série A',     region: 'Americas',      priority: 43, wstSlug: null }, // no WST coverage

	// CONCACAF / CONMEBOL club
	{ slug: 'concacaf-cc',     label: 'CONCACAF Champions Cup',  region: 'Confederations', priority: 50, wstSlug: 'concacaf-champions-league' },
	...
	{ slug: 'uefa-euros',      label: 'UEFA European Championship', region: 'National',   priority: 60, wstSlug: 'uefa-european-championship' },
	...
	{ slug: 'fifa-wcq',        label: 'World Cup Qualifiers',    region: 'National',      priority: 64, wstSlug: 'world-cup-qualifiers' },
];
